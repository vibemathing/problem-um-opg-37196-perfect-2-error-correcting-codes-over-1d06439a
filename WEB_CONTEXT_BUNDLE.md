...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37196"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-v1",
      "problem_contract_sha256": "5735d0c54d6898c2dd3d727dea313f5b972d2168deff198ace789897da57918a",
      "problem_id": "problem:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a",
      "route_id": "route:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-source-fidelity-01",
      "graph_id": "graph:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Does there exist a nontrivial perfect 2-error-correcting code over any finite alphabet, other than the ternary Golay code?"
          },
          "statement_sha256": "0ed4915a8bb3747bc4a63eabea00a1255bf725be75b60684de5a061a46bb98e0"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-root",
      "route_id": "route:um-opg-37196-perfect-2-error-correcting-codes-over-1d06439a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37196-c46da44f609c",
        "url": "https://www.unsolvedmath.com/problems/OPG-37196"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
